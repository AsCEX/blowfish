...
if(isset($_POST['encrypt'])){
	...
	$blowfish = $blowfishMod->decrypt($text, $key, $iv);
	...
	// echo $text2;
	$blowfish2 = $blowfishMod2->decrypt($text2, $key2, $iv2);
...
<body>
      ...
      <li class="nav-item">
        <a class="nav-link active" href="<?php echo SITEURL; ?>/decrypt.php">Decrypt</a>
      </li>
  </ul>
		</nav>
	...
	<div class ="row">
				...
				<?php if(isset($_POST['encrypt'])): ?>
					<div class ="col-12" style="border:1px solid #e2e2e2; margin-top:20px;padding:20px;margin-right:10px;">
						<h1>Blowfish Decryption Results</h1>

							<?php
							echo $ham1 = $blowfishMod->convBase($blowfish->plaintext, HEX, BIN);
							$ham2 = $blowfishMod2->convBase($blowfish2->plaintext, HEX, BIN);
						...
						<table class="table table-striped table-bordered table-dark table-sm">
							<thead>
								...
								<tr>
									...
									<td colspan="2" style="width:40%;text-align: center;"><?php echo sprintf("%.6f seconds",$blowfish->encryption_time); ?></td>
									<td colspan="2" style="width:50%;text-align: center;"><?php echo ($text2) ? sprintf("%.6f seconds",$blowfish2->encryption_time) : ""; ?></td>
								</tr>
								<tr>
									<td>Plain Text</td>
			...
			<div class="row">		
					...
					<div class="col-6 border p-3">
						  ...
						  <div class="form-group">
						    ...
						    <input type="text" class="form-control" required="required" id="exampleInputlastname" placeholder="key" name ="key" value='' autocomplete="off" />
						  </div>

						  <div class="form-group">
						    <label for="exampleInputlast name">Initialization Vector A <small class="inputType"></small></label>
						    <input type="text" class="form-control" id="exampleInputlastname" placeholder="vector" name ="vector" value="" autocomplete="off" />
						  </div>
					...
					<div class="col-6 border p-3">  
						  ...
						  <div class="form-group">
						    ...
						    <input type="text" class="form-control" id="exampleInputlastname" placeholder="key" name ="key2" value='' autocomplete="off" />
						  </div>

						  <div class="form-group">
						    <label for="exampleInputlast name">Initialization Vector B <small class="inputType2"></small></label>
						    <input type="text" class="form-control" id="exampleInputlastname" placeholder="vector" name ="vector2" value="" autocomplete="off" />
						  </div>
					</div>
				<button type="submit" name="encrypt" class="btn btn-danger" style="display:block;width:80%;margin:0 auto;">Decrypt</button>
